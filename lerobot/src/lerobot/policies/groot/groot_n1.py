...
class GR00TN15Config(PretrainedConfig):
    ...
    backbone_cfg: dict | None = field(init=False, default=None, metadata={"help": "Backbone configuration."})

    action_head_cfg: dict | None = field(init=False, default=None, metadata={"help": "Action head configuration."})

    action_horizon: int | None = field(init=False, default=None, metadata={"help": "Action horizon."})

    action_dim: int | None = field(init=False, default=None, metadata={"help": "Action dimension."})
